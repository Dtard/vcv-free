...
struct Ram : Module {
	...
	Ram() : Module(NUM_PARAMS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS) {}
	void step() override;
...
struct RamWidget : ModuleWidget {
	RamWidget(Ram *module) : ModuleWidget(module) {
...
Model *modelRam = Model::create<Ram, RamWidget>("23v", "Ram", "Ram", SEQUENCER_TAG);

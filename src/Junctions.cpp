...
struct Junctions : Module {
	...
	Junctions() : Module(NUM_PARAMS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS) {}
	void step() override;
...
Model *modelJunctions = Model::create<Junctions, JunctionsWidget>("23v", "Junctions", "Junctions", MIXER_TAG);

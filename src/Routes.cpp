...
struct Routes : Module {
	...
	Routes() : Module(NUM_PARAMS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS) {}
	void step() override;
...
struct RoutesWidget : ModuleWidget {
	RoutesWidget(Routes *module) : ModuleWidget(module) {
...
Model *modelRoutes = Model::create<Routes, RoutesWidget>("23v", "Routes", "Routes", OSCILLATOR_TAG);
